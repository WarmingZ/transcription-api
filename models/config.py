...
CPU_CHUNK_SIZE = 90  # секунд (оптимізовано для CPU)
CPU_MAX_WORKERS = 6  # Потоки для CPU
CPU_CACHE_MAX_SIZE = 8  # Кеш для CPU
...
DIARIZATION_MAX_WORKERS = 6  # Оптимізовано для 8 CPU (threads замість processes)
