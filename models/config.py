...
DEFAULT_CHUNK_SIZE = 90  # секунд (збільшено для кращого використання ресурсів)
MAX_WORKERS = 3  # Оптимізовано для 4-ядерного сервера (75% ядер для кращої продуктивності)
CACHE_MAX_SIZE = 5  # Збільшено для сервера з 8GB RAM
